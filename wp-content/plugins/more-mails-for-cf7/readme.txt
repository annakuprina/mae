...
If you only wish to send the same message to multiple recipients, you won't need this plugin; instead use the **To** field, or adding *Cc*/*Bcc* headers in the **Additional Headers** field as per [Contact Form 7's documentation](https://contactform7.com/adding-cc-bcc-and-other-mail-headers/).
